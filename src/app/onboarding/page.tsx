      ...
      <div className="w-full max-w-sm">
        ...
        {step === 1 && (
          <div className="mt-10 flex flex-col items-center text-center">
            {/* Logo */}
            <div className="flex h-20 w-20 items-center justify-center rounded-3xl bg-[#8B5CF6] shadow-[0_0_40px_rgba(139,92,246,0.4)] text-3xl font-black tracking-tighter text-white">
              F
            </div>

            <h1 className="mt-6 text-2xl font-bold leading-tight">
              Benvenuto su Filo,<br />
              <span className="text-[#A78BFA]">{fullName.split(" ")[0]}!</span>
            </h1>
            ...
            <button
              type="button"
              onClick={() => setStep(2)}
              className="mt-8 h-12 w-full rounded-2xl bg-[#8B5CF6] text-sm font-semibold text-white shadow-[0_0_24px_rgba(139,92,246,0.35)] transition hover:bg-[#7C3AED] active:scale-[0.98]"
            >
              Inizia
            </button>
          </div>
        ...
        {step === 2 && (
          <div className="mt-8">
            <h1 className="text-xl font-bold leading-tight">
              Aggiungi il tuo primo professionista di fiducia
            </h1>
            ...
            <button
              type="button"
              onClick={() => setStep(3)}
              className="mt-3 w-full text-center text-sm text-[#6B7280] transition hover:text-[#9CA3AF]"
            >
              Salta per ora
            </button>
          </div>
        ...
        {step === 3 && (
          <div className="mt-10 flex flex-col items-center text-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#25D366]/20 text-3xl">
            ...
            <Link
              href="/feed"
              className="mt-4 text-sm text-[#6B7280] transition hover:text-[#9CA3AF]"
            >
              Vai al feed →
            </Link>
          </div>
