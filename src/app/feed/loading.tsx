...
function SkeletonCard({ opacity = 1 }: { opacity?: number }) {
  return (
    <div className="animate-pulse rounded-[20px] border border-[#1a1a1a] bg-[#111111] p-5" style={{ opacity }}>
      {/* Header row: avatar + name/meta + badge */}
      <div className="flex items-center gap-3">
        <div className="h-12 w-12 shrink-0 rounded-full bg-[#1f1f1f]" />
        <div className="flex-1 space-y-2">
          <div className="h-3.5 w-28 rounded-full bg-[#1f1f1f]" />
      ...
      {/* Professional name */}
      <div className="mt-4 h-5 w-3/5 rounded-full bg-[#1f1f1f]" />
      ...
      <div className="flex items-center gap-5">
        <div className="h-[22px] w-10 rounded-full bg-[#1a1a1a]" />
        <div className="h-[22px] w-10 rounded-full bg-[#1a1a1a]" />
        <div className="h-[22px] w-10 rounded-full bg-[#1a1a1a]" />
        <div className="ml-auto h-[22px] w-5 rounded-full bg-[#1a1a1a]" />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="min-h-dvh bg-[#0a0a0a] text-white">
      ...
      <div className="mx-auto max-w-[430px] px-4 pb-3 pt-4">
        <div className="h-10 animate-pulse rounded-full bg-[#111111]" />
      </div>
