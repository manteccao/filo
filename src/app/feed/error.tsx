  ...
  return (
    <div className="min-h-dvh bg-background text-white">
      <header className="sticky top-0 z-40 border-b border-border bg-background/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-[430px] items-center justify-center px-4 py-4">
      ...
      <main className="mx-auto flex max-w-[430px] flex-col items-center justify-center px-6 py-24 text-center">
        ...
        <p className="mt-1.5 text-sm text-muted-foreground">Non è stato possibile caricare il feed.</p>
        <button
          onClick={reset}
